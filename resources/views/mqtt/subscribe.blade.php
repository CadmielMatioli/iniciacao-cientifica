    ...
    <div class="row justify-content-center">
        ...
        @include('includes.flashalert')
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('sendmsg.mqtt')}}" method="post">
                    @csrf
                        <div class="row">
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                <label for="message" class="form-label">Mensagem<span class="form-required">*</span></label>
                                <input type="text" id="message" name="message" class="form-control form-group">
